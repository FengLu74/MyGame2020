...
namespace XLua.CSObjectWrap
{
    ...
    public class CommonMsicGeneralMsicWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Common.Msic.GeneralMsic);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					Common.Msic.GeneralMsic gen_ret = new Common.Msic.GeneralMsic();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Common.Msic.GeneralMsic constructor!");
		    ...
		    try {
                ...
                
                {
                    ...
                    object[] _param = (object[])translator.GetObject(L, 3, typeof(object[]));
                        ...
                        object gen_ret = Common.Msic.GeneralMsic.CallNonPublicMethod( _instance, _methodName, _param );
        ...
        static int _m_SetRectTransformParent_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    Common.Msic.GeneralMsic.SetRectTransformParent( _child, _parent );
        ...
        static int _m_SetParent_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    Common.Msic.GeneralMsic.SetParent( _go, _parentGo, _worldPositionStays );
		    ...
		    try {
                ...
                
                {
                    ...
                    string _name = LuaAPI.lua_tostring(L, 3);
                        ...
                        UnityEngine.GameObject gen_ret = Common.Msic.GeneralMsic.NewGameObject( _Pos, _parentGo, _name );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    UnityEngine.Vector3 _localPos;translator.Get(L, 2, out _localPos);
                        ...
                        UnityEngine.Vector3 gen_ret = Common.Msic.GeneralMsic.TransformLocalPosToWorldPos( _t, _localPos );
        ...
        static int _m_FindChild_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 3&& translator.Assignable<UnityEngine.Transform>(L, 1)&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    bool _includeinactive = LuaAPI.lua_toboolean(L, 3);
                        ...
                        UnityEngine.Transform gen_ret = Common.Msic.GeneralMsic.FindChild( _root, _name, _includeinactive );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 2&& translator.Assignable<UnityEngine.Transform>(L, 1)&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)) 
                {
                    ...
                    string _name = LuaAPI.lua_tostring(L, 2);
                        ...
                        UnityEngine.Transform gen_ret = Common.Msic.GeneralMsic.FindChild( _root, _name );
                        translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Common.Msic.GeneralMsic.FindChild!");
		    ...
		    try {
                ...
                
                {
                    ...
                    bool _includeInactive = LuaAPI.lua_toboolean(L, 2);
                        ...
                        UnityEngine.Transform[] gen_ret = Common.Msic.GeneralMsic.FindChilds( _root, _includeInactive );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _name = LuaAPI.lua_tostring(L, 1);
                        ...
                        UnityEngine.GameObject gen_ret = Common.Msic.GeneralMsic.FindGameObject( _name );
                        translator.Push(L, gen_ret);
        ...
        static int _m_DestroyAllChilds_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    Common.Msic.GeneralMsic.DestroyAllChilds( _obj );
		    ...
		    try {
                ...
                
                {
                    ...
                    string _path = LuaAPI.lua_tostring(L, 2);
                        ...
                        UnityEngine.GameObject gen_ret = Common.Msic.GeneralMsic.FindChildByPath( _pObject, _path );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _absolutePathInScene = LuaAPI.lua_tostring(L, 1);
                        ...
                        UnityEngine.GameObject gen_ret = Common.Msic.GeneralMsic.FindByPath( _absolutePathInScene );
                        translator.Push(L, gen_ret);
        ...
        static int _m_SetObjectToLayer_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    Common.Msic.GeneralMsic.SetObjectToLayer( _go, _layerName, _allChildsAlso );
		    ...
		    try {
                ...
                
                {
                    ...
                    UnityEngine.Transform _toParent = (UnityEngine.Transform)translator.GetObject(L, 2, typeof(UnityEngine.Transform));
                        ...
                        UnityEngine.GameObject gen_ret = Common.Msic.GeneralMsic.CopyRectTransformToParent( _go, _toParent );
                        translator.Push(L, gen_ret);
        ...
        static int _m_ScaleTexture_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 2&& translator.Assignable<UnityEngine.Texture2D>(L, 1)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)) 
                {
                    ...
                    float _scale = (float)LuaAPI.lua_tonumber(L, 2);
                        ...
                        UnityEngine.Texture2D gen_ret = Common.Msic.GeneralMsic.ScaleTexture( _source, _scale );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 3&& translator.Assignable<UnityEngine.Texture2D>(L, 1)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    int _targetheight = LuaAPI.xlua_tointeger(L, 3);
                        ...
                        UnityEngine.Texture2D gen_ret = Common.Msic.GeneralMsic.ScaleTexture( _source, _targetWigth, _targetheight );
                        translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Common.Msic.GeneralMsic.ScaleTexture!");
        ...
        static int _m_UnloadAssets_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    Common.Msic.GeneralMsic.UnloadAssets( _o );
        ...
        static int _m_UnloadUnusedAssets_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    Common.Msic.GeneralMsic.UnloadUnusedAssets(  );
        ...
        static int _m_GCRelease_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    Common.Msic.GeneralMsic.GCRelease(  );
        ...
        static int _m_WriteFileAtEnd_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 3&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    Common.Msic.GeneralMsic.WriteFileAtEnd( _fileFullPathName, _content, _reCreate );
                ...
                if(gen_param_count == 2&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)) 
                {
                    ...
                    Common.Msic.GeneralMsic.WriteFileAtEnd( _fileFullPathName, _content );
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Common.Msic.GeneralMsic.WriteFileAtEnd!");
		    ...
		    try {
                ...
                
                {
                    ...
                    string _end = LuaAPI.lua_tostring(L, 3);
                        ...
                        string gen_ret = Common.Msic.GeneralMsic.ReadFileTrim( _fileFullPathName, _start, _end );
		    ...
		    try {
                ...
                
                {
                    ...
                    string _end = LuaAPI.lua_tostring(L, 3);
                        ...
                        string[] gen_ret = Common.Msic.GeneralMsic.ReadFileLinesTrim( _fileFullPathName, _start, _end );
                        translator.Push(L, gen_ret);
        ...
        static int _m_DeleteFile_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    Common.Msic.GeneralMsic.DeleteFile( _filePath );
        ...
        static int _m_StringTrim_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 4&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& (LuaAPI.lua_isnil(L, 3) || LuaAPI.lua_type(L, 3) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    bool _lastIndex = LuaAPI.lua_toboolean(L, 4);
                        ...
                        string gen_ret = Common.Msic.GeneralMsic.StringTrim( _txt, _start, _end, _lastIndex );
                        LuaAPI.lua_pushstring(L, gen_ret);
                ...
                if(gen_param_count == 3&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& (LuaAPI.lua_isnil(L, 3) || LuaAPI.lua_type(L, 3) == LuaTypes.LUA_TSTRING)) 
                {
                    ...
                    string _end = LuaAPI.lua_tostring(L, 3);
                        ...
                        string gen_ret = Common.Msic.GeneralMsic.StringTrim( _txt, _start, _end );
                        LuaAPI.lua_pushstring(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Common.Msic.GeneralMsic.StringTrim!");
		    ...
		    try {
                ...
                
                {
                    ...
                    int _index = LuaAPI.xlua_tointeger(L, 3);
                        ...
                        string gen_ret = Common.Msic.GeneralMsic.StringInsert( _str, _insertStr, _index );
                        LuaAPI.lua_pushstring(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    int _length = LuaAPI.xlua_tointeger(L, 3);
                        ...
                        byte[] gen_ret = Common.Msic.GeneralMsic.ReadBinaryFileOffset( _filePathName, _offset, _length );
                        LuaAPI.lua_pushstring(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _filePathName = LuaAPI.lua_tostring(L, 1);
                        ...
                        byte[] gen_ret = Common.Msic.GeneralMsic.ReadBinaryFile( _filePathName );
                        LuaAPI.lua_pushstring(L, gen_ret);
        ...
        static int _m_WriteBinaryFile_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 3&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& translator.Assignable<System.IO.FileMode>(L, 3)) 
                {
                    ...
                    System.IO.FileMode _fileMode;translator.Get(L, 3, out _fileMode);
                        ...
                        bool gen_ret = Common.Msic.GeneralMsic.WriteBinaryFile( _filePathName, _buff, _fileMode );
                ...
                if(gen_param_count == 2&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)) 
                {
                    ...
                    byte[] _buff = LuaAPI.lua_tobytes(L, 2);
                        ...
                        bool gen_ret = Common.Msic.GeneralMsic.WriteBinaryFile( _filePathName, _buff );
                        LuaAPI.lua_pushboolean(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Common.Msic.GeneralMsic.WriteBinaryFile!");
		    ...
		    try {
                ...
                
                {
                    string _fileName = LuaAPI.lua_tostring(L, 1);
                        ...
                        string gen_ret = Common.Msic.GeneralMsic.GetMD5HashFromFile( _fileName );
                        LuaAPI.lua_pushstring(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _str = LuaAPI.lua_tostring(L, 1);
                        ...
                        string gen_ret = Common.Msic.GeneralMsic.StringToMD5Hash( _str );
                        LuaAPI.lua_pushstring(L, gen_ret);
        ...
        static int _m_EncryptString_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 3&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    bool _handLastPoint = LuaAPI.lua_toboolean(L, 3);
                        ...
                        string gen_ret = Common.Msic.GeneralMsic.EncryptString( _str, _key, _handLastPoint );
                        LuaAPI.lua_pushstring(L, gen_ret);
                ...
                if(gen_param_count == 2&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)) 
                {
                    ...
                    string _key = LuaAPI.lua_tostring(L, 2);
                        ...
                        string gen_ret = Common.Msic.GeneralMsic.EncryptString( _str, _key );
                        LuaAPI.lua_pushstring(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Common.Msic.GeneralMsic.EncryptString!");
        ...
        static int _m_DecryptString_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 3&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    bool _handLastPoint = LuaAPI.lua_toboolean(L, 3);
                        ...
                        string gen_ret = Common.Msic.GeneralMsic.DecryptString( _str, _key, _handLastPoint );
                        LuaAPI.lua_pushstring(L, gen_ret);
                ...
                if(gen_param_count == 2&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)) 
                {
                    ...
                    string _key = LuaAPI.lua_tostring(L, 2);
                        ...
                        string gen_ret = Common.Msic.GeneralMsic.DecryptString( _str, _key );
                        LuaAPI.lua_pushstring(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Common.Msic.GeneralMsic.DecryptString!");
        ...
        static int _m_EncryptFile_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 4&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& (LuaAPI.lua_isnil(L, 3) || LuaAPI.lua_type(L, 3) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    Common.Msic.GeneralMsic.EncryptFile( _filePathName, _fileKey, _nameKey, _handNameLastPoint );
                ...
                if(gen_param_count == 3&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& (LuaAPI.lua_isnil(L, 3) || LuaAPI.lua_type(L, 3) == LuaTypes.LUA_TSTRING)) 
                {
                    ...
                    Common.Msic.GeneralMsic.EncryptFile( _filePathName, _fileKey, _nameKey );
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Common.Msic.GeneralMsic.EncryptFile!");
        ...
        static int _m_DecryptFile_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 4&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& (LuaAPI.lua_isnil(L, 3) || LuaAPI.lua_type(L, 3) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    Common.Msic.GeneralMsic.DecryptFile( _filePathName, _fileKey, _nameKey, _handNameLastPoint );
                ...
                if(gen_param_count == 3&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& (LuaAPI.lua_isnil(L, 3) || LuaAPI.lua_type(L, 3) == LuaTypes.LUA_TSTRING)) 
                {
                    ...
                    Common.Msic.GeneralMsic.DecryptFile( _filePathName, _fileKey, _nameKey );
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Common.Msic.GeneralMsic.DecryptFile!");
		    ...
		    try {
                ...
                
                {
                    ...
                    string _key = LuaAPI.lua_tostring(L, 2);
                        ...
                        byte[] gen_ret = Common.Msic.GeneralMsic.Encrypt( _data, _key );
                        LuaAPI.lua_pushstring(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    string _key = LuaAPI.lua_tostring(L, 2);
                        ...
                        byte[] gen_ret = Common.Msic.GeneralMsic.Decrypt( _data, _key );
                        LuaAPI.lua_pushstring(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    UnityEngine.Vector3 _touchPosition;translator.Get(L, 1, out _touchPosition);
                        ...
                        bool gen_ret = Common.Msic.GeneralMsic.CheckUIOp( _touchPosition );
                        LuaAPI.lua_pushboolean(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    long _timeStamps = LuaAPI.lua_toint64(L, 1);
                        ...
                        System.DateTime gen_ret = Common.Msic.GeneralMsic.TimeStampsToDataTime( _timeStamps );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _str = LuaAPI.lua_tostring(L, 1);
                        ...
                        bool gen_ret = Common.Msic.GeneralMsic.IsValidMailAddress( _str );
                        LuaAPI.lua_pushboolean(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    UnityEngine.Transform _t = (UnityEngine.Transform)translator.GetObject(L, 1, typeof(UnityEngine.Transform));
                        ...
                        string gen_ret = Common.Msic.GeneralMsic.GetGameObjectPath( _t );
                        LuaAPI.lua_pushstring(L, gen_ret);
