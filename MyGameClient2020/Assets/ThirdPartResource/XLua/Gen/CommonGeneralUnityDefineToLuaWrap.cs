...
namespace XLua.CSObjectWrap
{
    ...
    public class CommonGeneralUnityDefineToLuaWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Common.General.UnityDefineToLua);
        ...
        {
            return LuaAPI.luaL_error(L, "Common.General.UnityDefineToLua does not have a constructor!");
        }
        ...
        static int _g_get_UNITY_EDITOR(RealStatePtr L)
        {
		    try {
			    ...
			    LuaAPI.lua_pushboolean(L, Common.General.UnityDefineToLua.UNITY_EDITOR);
        ...
        static int _g_get_UNITY_STANDALONE(RealStatePtr L)
        {
		    try {
			    ...
			    LuaAPI.lua_pushboolean(L, Common.General.UnityDefineToLua.UNITY_STANDALONE);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_UNITY_ANDROID(RealStatePtr L)
        {
		    try {
			    ...
			    LuaAPI.lua_pushboolean(L, Common.General.UnityDefineToLua.UNITY_ANDROID);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_UNITY_IOS(RealStatePtr L)
        {
		    try {
			    ...
			    LuaAPI.lua_pushboolean(L, Common.General.UnityDefineToLua.UNITY_IOS);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
