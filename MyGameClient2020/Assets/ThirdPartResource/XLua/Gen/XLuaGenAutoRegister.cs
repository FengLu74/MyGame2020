...
namespace XLua.CSObjectWrap
{
    public class XLua_Gen_Initer_Register__
	{
        ...
        static void wrapInit1(LuaEnv luaenv, ObjectTranslator translator)
        {
            ...
            translator.DelayWrapLoader(typeof(MGame.General.LuaCallCSharpEvent), MGameGeneralLuaCallCSharpEventWrap.__Register);
        ...
        static void wrapInit2(LuaEnv luaenv, ObjectTranslator translator)
        {
            ...
            translator.DelayWrapLoader(typeof(MGame.General.UnityEngineObjectExtention), MGameGeneralUnityEngineObjectExtentionWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(MGame.General.CachedMono), MGameGeneralCachedMonoWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(MGame.General.UnityDefineToLua), MGameGeneralUnityDefineToLuaWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(MGame.GameBattle.Manager.LogicManager), MGameGameBattleManagerLogicManagerWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(MGame.Msic.GeneralMsic), MGameMsicGeneralMsicWrap.__Register);
	    ...
	    static InternalGlobals()
		{
		    extensionMethodMap = new Dictionary<Type, IEnumerable<MethodInfo>>()
			{
				...
				{typeof(UnityEngine.Object), new List<MethodInfo>(){
				  ...
				  new __GEN_DELEGATE0(MGame.General.UnityEngineObjectExtention.IsNull)
