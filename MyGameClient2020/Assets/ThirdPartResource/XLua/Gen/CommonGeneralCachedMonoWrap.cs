...
namespace XLua.CSObjectWrap
{
    ...
    public class CommonGeneralCachedMonoWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Common.General.CachedMono);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					Common.General.CachedMono gen_ret = new Common.General.CachedMono();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Common.General.CachedMono constructor!");
        ...
        static int _g_get_CachedGameObject(RealStatePtr L)
        {
		    try {
                ...
                Common.General.CachedMono gen_to_be_invoked = (Common.General.CachedMono)translator.FastGetCSObj(L, 1);
