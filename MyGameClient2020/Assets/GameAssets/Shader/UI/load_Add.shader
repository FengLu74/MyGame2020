...
Shader "MGame/UI/loadingADD"
{
Properties
{
[PerRendererData] _MainTex("Sprite Texture", 2D) = "white" {}
SpriteSheetAnimationUV_Size_1("SpriteSheetAnimationUV_Size_1", Range(2, 16)) = 5
SpriteSheetAnimationUV_Frame_1("SpriteSheetAnimationUV_Frame_1", Range(1, 120)) = 19
