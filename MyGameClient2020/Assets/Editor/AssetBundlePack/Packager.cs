...
//    //            }    
//    //        } else {
//    //            //ToLuaMenu.CopyLuaBytesFiles(srcDirs[i], streamDir);//ljs
//    //        }
//    //    }
...
//    //[MenuItem("LuaFramework/Build Test")]

//    //public static void BuildTest()
//    //{
//    //    // string tempAssetPath = AppDataPath + "/Art";
//    //    string tempAssetPath = AppDataPath + "/AssetsRes";
//    //    List<string> tempFileList = new List<string>();
//    //    CalcAbFileList(tempAssetPath, ref tempFileList);//指定目录，计算当前目录下需要打包的文件信息
//    //    List<AssetBundleBuild> tempAbBuildList = new List<AssetBundleBuild>();
//    //    BuildAbFiles(tempFileList, ref tempAbBuildList);//根据需要打包的文件信息，计算出AB文件信息
//    //                                                    //string _resPath = "Assets/" + AppConst.AssetDir;
...
//    //    BuildPipeline.BuildAssetBundles(tempStreamPath, tempAbBuildList.ToArray(), BuildAssetBundleOptions.None, BuildTarget.StandaloneWindows);//打包AB

//   // }

//    //[MenuItem("LuaFramework/Build FileTxt")]
//    //public static void BuildFileTxt()
//    //{
//    //    // BuildFileIndex();

//    //    string tempStreamPath = Application.streamingAssetsPath;
//    //    BuildFileIndex(tempStreamPath, s_VerUpdateFileName, true);
//    //    BuildFileIndex(tempStreamPath, s_newVerUpdateFileName, false);
